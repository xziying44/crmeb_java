      ...
      <div class="padding-add">
        <el-form ref="formRef" :model="form" :rules="rules" label-width="90px" size="small">
          ...
          <el-form-item label="出库类型" prop="type">
            <el-select v-model="form.type" placeholder="请选择出库类型" class="selWidth">
              <el-option label="报损出库" :value="6" />
              <el-option label="其他出库" :value="8" />
            </el-select>
          </el-form-item>
          ...
          <el-form-item>
            <el-button type="primary" size="small" :loading="submitLoading" @click="handleSubmit" v-hasPermi="['admin:stock:out']"
              >提交出库</el-button
            >
...
<script>
import { stockOutApi } from '@/api/stock.js';
